...
<body>
    ...
    <nav class="navbar navbar-expand-lg pt-4 pb-4" style="background-color: #96B6C5; color:beige;">
        <div class="container-fluid">
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <form class="d-flex" role="search" action="{{ route('jenis') }}" method="GET">
                    <input class="form-control me-3" type="search" name="jenis" placeholder="Search Category"
                        aria-label="Search">
