...
<div class="card mb-3">
@if($posts[0]->image)
      <div style="max-heigh: 400px; overflow:hidden;"><img src="{{ asset('storege/' . $posts[0]->image) }}" alt="
  ...
  <div class="row">
    ...
    <div class="col-md-4 mb-3">
      <div class="card">
        ...
        @if($post->image)
          <img src="{{ asset('storege/' . $post->image) }}" alt="
        ...
        <div class="card-body">
          ...
          <a href="/posts/{{ $post->slug }}" class="btn btn-primary">Reed More</a>
        </div>
      </div>
    </div>
    @endforeach
