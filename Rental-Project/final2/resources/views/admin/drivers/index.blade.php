...
@section('content')
    <div class="card mt-5">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h3>Daftar Driver</h3>
            <a href="{{ route('drivers.create') }}" class="btn" style="background-color: rgb(4, 66, 253); color: white">Tambah Driver</a>
        </div>
        <div class="card-body">
