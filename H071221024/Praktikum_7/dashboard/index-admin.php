...
if ($op == 'edit') {
    ...
    $stmt = mysqli_prepare($connection->connect, $query);
...
if (isset($_POST['simpan'])) {
    ...
    if ($nim && $nama && $prodi) {
        if ($op == 'edit') {
            $query = "UPDATE users SET username=?, nama=?, prodi=? WHERE id=?";
            $stmt = mysqli_prepare($connection->connect, $query);
            $stmt->bind_param("ssss", $nim, $nama, $prodi, $id);
            if ($stmt->execute()) {
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td scope="row">
                                    <a href="?op=edit&id=<?= $data['id'] ?>" tyle="color: white;>
