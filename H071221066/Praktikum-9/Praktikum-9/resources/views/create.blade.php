        ...
        <form class="row g-3" action="{{ route('toko.store') }}" method="POST">
            ...
            <div class="row text-center">
                <div class="col-2 mt-3">
                    <button type="submit" class="btn search col-12" style="background-color: #ed8191;">Add</button>
                </div>
                <div class="col-2 mt-3">
                    <a href="{{ route('toko.index') }}" class="btn search col-12" style="background-color: #1476a7;">Back</a>
                </div>
            </div>
        </form>
    </div>
