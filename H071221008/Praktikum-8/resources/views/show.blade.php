...
<style>
    ...
    nav li {
        ...
        list-style: none;
        box-shadow: inset 0 0 0 0 #ACB1D6;
        margin: 0 -.25rem;
        padding: 0 .25rem;
    ...
    nav li:hover {
        border-radius: 10px;
        box-shadow: inset 100px 0 0 0 #ACB1D6;
        color: black;
    }
...
<body>
    ...
    <div class="container">
        ...
        <button class="btn search mt-4 mb-4"><a href="/product" style="text-decoration: none; color: blue;">Back to
                products</a>
        </button>
